...
<div id="content">
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top">
		<div class="container-fluid">
			...
			<span class="text-left">
				<a href="<?php echo site_url('KasirControl/home'); ?>">Home</a> / <a href="<?php echo site_url('KasirControl/m_member'); ?>">Manajemen Member</a> / <span class="text-muted">Tambah Member</span>
			</span> 
		</div>
	</nav>
	...
	<div class="isi">
		...
		<form class="tabel">
			...
			<div class="form-row">
				<div class="col-md-2 mb-3 text-right">
					<a href="<?php echo site_url('KasirControl/m_member'); ?>" class="btn btn-danger" type="button">Batal</a>
				</div>
				<div class="col-md-10 mb-3">
