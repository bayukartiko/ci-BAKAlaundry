    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    <a href="#" class="active"><i class="fas fa-th-list"></i> Manajemen Laundry</a>
                </li>
                <li>
        ...
        <div id="content">
            ...
            <div class="isi">
                ...
                <form class="tabel">
                    ...
                    <div class="form-row">
                        <div class="col-md-2 mb-3 text-right">
                            <a href="<?php echo site_url('BAKAcontrol/m_laundry'); ?>" class="btn btn-danger" type="button">Batal</a>
                        </div>
                        <div class="col-md-10 mb-3">
