...
<div id="content">
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top">
		<div class="container-fluid">
			...
			<span class="text-left">
				<a href="<?php echo site_url('AdminControl/home'); ?>">Home</a> / <span class="text-muted">Manajemen User</span> / <a href="<?php echo site_url('AdminControl/m_admin'); ?>">Admin</a> / <span class="text-muted">Detail admin</>
			</span> 
		</div>
	</nav>
	...
	<div class="isi">
		...
		<h6><i class="fas fa-user-cog"></i> Detail biodata admin</h6>
		
		<form class="tabel">
		<fieldset disabled>
		
			<p class="text-center mb-5"><i class="fas fa-user-cog"></i> Detail biodata admin</p>
			...
			<div class="form-row">
				<div class="col-md-12 mb-3">
					<a href="<?php echo site_url('AdminControl/m_admin'); ?>" class="btn btn-info" type="button">Mengerti</a>
				</div>
				<!-- <div class="col-md-10 mb-3">
