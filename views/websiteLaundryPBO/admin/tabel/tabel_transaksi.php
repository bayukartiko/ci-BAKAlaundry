		...
		<tr>
			...
			<td> 
				...
				<!-- Membuat sebuah textbox hidden yang akan digunakan untuk form detail -->
					...
					<!-- harga_paket -->
						<input type="hidden" class="harga_paket-value_detail" value="<?php foreach($paket as $pakets) : if( $pakets->id == $data_transaksi->id_paket){ echo $pakets->harga; } endforeach; ?>">
					<!-- satuan_paket -->
					...
					<!-- total -->
						<input type="hidden" class="total-value_detail" value="<?= $data_transaksi->total; ?>">
					<!-- tunai -->
						<input type="hidden" class="tunai-value_detail" value="<?= $data_transaksi->tunai; ?>">
					<!-- kembali -->
						<input type="hidden" class="kembali-value_detail" value="<?= $data_transaksi->kembali_or_kurang; ?>">
					<!-- tipe_pembayaran -->
