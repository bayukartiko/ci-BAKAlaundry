...
<div id="content">
	...
	<div class="isi">
		...
		<div class="tabel">
			...
			<!-- <button type="button" class="btn btn-info" data-toggle="modal" data-target="#ModalTambah">Tambah Kasir</button> -->
			<br><br>
					...
					<tr>
						...
						<?php }else{ ?>
							<td> 
								...
								<button type="button" class="btn btn-info" data-toggle="modal" data-target="#ModalEdit<?= $data_kasir->id ?>">Edit</button>
						...
						<td> 
							...
							<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#ModalDetail<?= $data_kasir->id ?>">Detail</button>
						</td>
					</tr>
					<?php 
						}
...
<!-- Modal edit -->
	<?php foreach($tb_user as $edit){  ?>
		<form action="<?= site_url('AdminControl/aksi_edit_kasir') ?>" method="POST" enctype="multipart/form-data">
