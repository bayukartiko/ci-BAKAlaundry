...
<div id="content">
	...
	<div class="isi">
		...
		<div class="tabel">
			...
			<button type="button" name="btn-tambah" id="btn-tambah" class="btn btn-info" data-toggle="modal" data-target="#form-modal-tambah-kasir">Tambah Kasir</button>
			...
			<div id="view">
				<?php $this->load->view('websiteLaundryPBO/admin/tabel/tabel_kasir', ['tb_user'=>$tb_user]); ?>
			</div>
			
		</div>

<!-- modal crud kasir ajax -->
	<!-- edit -->
		<div class="modal fade" id="form-modal-edit-kasir" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
			<div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title">
							<i class="fas fa-user-edit"></i> Ubah biodata kasir
						</h5>
					...
					<div class="modal-body">
						...
						<form enctype="multipart/form-data" id="modal-ubah-kasir">
	...
	<!-- hapus -->
		<div class="modal fade" id="form-modal-hapus-kasir" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
			<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title">
							<i class="fas fa-fw fa-user-minus"></i> Konfirmasi hapus kasir
						</h5>
						<button type="button" class="close" data-dismiss="modal" aria-label="Close">
							<span aria-hidden="true">&times;</span>
						</button>
					...
					<div class="modal-body">
						<form enctype="multipart/form-data" id="modal-hapus-kasir">
	...
	<!-- tambah -->
		<div class="modal fade" id="form-modal-tambah-kasir" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
			<div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title">
					...
					<div class="modal-body">
						...
						<form enctype="multipart/form-data" id="modal-tambah-kasir">
							<div class="form-row">
								<div class="col-md-2 mb-3 text-right">
									<label for="namalengkap">Nama Lengkap</label>
								</div>
	...
	<!-- detail -->
		<div class="modal fade" id="form-modal-detail-kasir" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
			<div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
				<div class="modal-content">
					<div class="modal-header">
					...
					<div class="modal-body">
						<fieldset disabled>
							...
							<div class="form-row">
								...
								<div class="col-md-10 mb-3">
									<textarea name="alamat" id="alamat_detail" class="form-control" placeholder="Masukkan Alamat Kasir" cols="30" rows="5" required disabled></textarea>
								</div>
							</div>
							<div class="form-row">
								<div class="col-md-2 mb-3 text-right">
		...
		// crud kasir
			...
			// tambah
				...
				$('#btn-simpan').click(function(){ // Ketika tombol simpan didalam modal di klik
					...
					$.ajax({
						url: '<?= base_url(); ?>AdminControl/crud_kasir/simpan/'+null+'', // URL tujuan
						type: 'POST',
						// data: $("#form-modal form").serialize(),
						data: new FormData(document.getElementById('modal-tambah-kasir')),
						processData:false,
						contentType:false,
						cache:false,
						async:false,
						...
						success: function(response){
							...
							if(response.status == 'sukses'){ // Jika Statusnya = sukses
								...
								Toast.fire({
									icon: 'success',
									title: 'Data kasir berhasil disimpan'
								});
			...
			// edit
				...
				$('#btn-ubah').click(function(){
					...
					$.ajax({
						url: '<?= base_url(); ?>AdminControl/crud_kasir/ubah/'+id+'', // URL tujuan
						type: 'POST',
						// data: $("#form-modal form").serialize(),
						data: new FormData(document.getElementById('modal-ubah-kasir')),
						processData:false,
						contentType:false,
						cache:false,
						async:false,
						...
						success: function(response){
							...
							if(response.status == 'sukses'){
								...
								$('#form-modal-edit-kasir').modal('hide');
			...
			// hapus
				...
				$("#btn-hapus").click(function(){ // ketika tombol hapus didalam modal di klik
					...
					$.ajax({
						url: '<?= base_url(); ?>AdminControl/crud_kasir/hapus/'+id+'', // URL tujuan
						type: 'POST', // Tentukan type nya POST atau GET
						data: new FormData(document.getElementById('modal-hapus-kasir')),
						processData:false,
						contentType:false,
						cache:false,
						async:false,
						...
						success: function(response){ // Ketika proses pengiriman berhasil
							...
							$('#form-modal-hapus-kasir').modal('hide'); // Close / Tutup Modal Dialog
