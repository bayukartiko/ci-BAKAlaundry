...
<div id="content">
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top">
		<div class="container-fluid">
			...
			<span class="text-left">
				<a href="<?php echo site_url('AdminControl/home'); ?>">Home</a> / <span class="text-muted">Manajemen User</span> / <a href="<?php echo site_url('AdminControl/m_owner'); ?>">Owner</a> / <span class="text-muted">Edit Owner</>
			</span> 
		</div>
	</nav>
	...
	<div class="isi">
		...
		<h6><i class="fas fa-user-edit"></i> Edit Data Owner</h6>
		
		<form class="tabel" action="<?= site_url('AdminControl/aksi_edit_owner') ?>" method="POST" enctype="multipart/form-data">
			<p class="text-center mb-5"><i class="fas fa-user-edit"></i> Edit Data Owner</p>


			<?php foreach($data_edit_owner as $edit){ ?>
