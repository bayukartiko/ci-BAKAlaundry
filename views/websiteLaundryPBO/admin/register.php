      ...
      <div class="container">
          <form class="form-daftar">
              ...
              <br>
                ...
                <label for="inputAlamatPengguna" class="sr-only">Email</label>
                <input type="email" id="inputEmailPengguna" class="form-control" placeholder="Email" required>
                <!-- <label for="inputNamaPengguna" class="sr-only">Gender</label>
                    <input class="form-check-input" type="radio" name="pilihKelamin" id="pria" value="option1" checked>
                        <label class="form-check-label" for="pria">
                            Pria
                        </label>
                    <input class="form-check-input" type="radio" name="pilihKelamin" id="wanita" value="option2">
                        <label class="form-check-label" for="wanita">
                            Wanita
                        </label> -->

                <label for="inputSandi1" class="sr-only">Kata Sandi</label>
                <input type="password" id="inputSandi1" class="form-control" placeholder="Kata Sandi" required>
                ...
                <input type="password" id="inputSandi2" class="form-control" placeholder="Konfirmasi Kata Sandi" required>
                <span toggle="#inputSandi2" class="far fa-eye ikon-mata lihat-konfirmasi-password"></span>

                <br>

              <a href="<?php echo site_url('BAKAcontrol/index'); ?>" class="btn tombolDaftar btn-lg btn-primary btn-block" type="submit">Daftar</a>
              <hr>
